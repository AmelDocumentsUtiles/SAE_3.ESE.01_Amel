...
int main(void)
{
  ...
  while (1)
  {
	  ...
	  A1 = HAL_GPIO_ReadPin(A1_GPIO_Port, A1_Pin);
	  A2 = HAL_GPIO_ReadPin(A2_GPIO_Port, A2_Pin);
	  ...
	  A = config & 		0b00000111;
	  ATT = config &    0b00010000;
	  ACDC = config &   0b00001000;
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, LD2_Pin|LED1_Pin|A0_Pin|A1_Pin
                          |A2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, ACDC_Pin|ATT_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LD2_Pin LED1_Pin A0_Pin A1_Pin
                           A2_Pin */
  GPIO_InitStruct.Pin = LD2_Pin|LED1_Pin|A0_Pin|A1_Pin
                          |A2_Pin;
  ...
  /*Configure GPIO pins : ACDC_Pin ATT_Pin */
  GPIO_InitStruct.Pin = ACDC_Pin|ATT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
